#!/usr/bin/env python3
"""
Simplified test script for the Toronto Road Segment Crash Risk Prediction Pipeline

This script tests each component using a simplified spatial join approach.
"""
...
def test_spatial_join_simple(collision_data, ksi_data, road_network):
    """Test simplified spatial join step"""
    print("\n" + "=" * 60)
    print("STEP 2: Testing Simplified Spatial Join")
    print("=" * 60)
    
    try:
        from src.data_processing.spatial_join_simple import perform_spatial_join_simple
        
        segment_crashes = perform_spatial_join_simple(collision_data, ksi_data, road_network)
        
        print(f"✅ Simplified spatial join successful!")
        ...
        print(f"❌ Simplified spatial join failed: {str(e)}")
        import traceback
        traceback.print_exc()
        return None
...
def main():
    """Run all pipeline tests with simplified approach"""
    print("🚀 Testing Toronto Road Segment Crash Risk Prediction Pipeline (Simplified)")
    print("=" * 80)
    ...
    # Step 2: Simplified Spatial Join
    segment_crashes = test_spatial_join_simple(collision_data, ksi_data, road_network)
    ...
    # Summary
    print("\n" + "=" * 80)
    print("🎉 ALL PIPELINE TESTS PASSED (Simplified Approach)!")
    print("=" * 80)
