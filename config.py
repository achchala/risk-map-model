...
FEATURE_COLUMNS = [
    ...
    # Crash-derived features removed (num_total_crashes', 'num_ksi_crashes', 'fatality_flag')
    # Simulated temporal features removed ('weekend_crash_ratio', 'avg_hour', 'time_of_day_*', 'season_*')
]
